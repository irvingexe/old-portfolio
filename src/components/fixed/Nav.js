...
export default function Nav() {
    ...
    return (
        <nav id="nav" className="fixed font-xs">
            <label htmlFor="#home" className="App-logo" onMouseEnter={cursorHover} onMouseLeave={resetCursor} onClick={() => changeSection("cover")}>
                <a id="home" href="#cover"><Logo/></a>
            </label>
            <ul id="menu-items"   className={"center links" + (menu? " active" :"")}>
                <li className={"link" + ((state.section === "ido")? " active" :"")} onClick={() => changeSection("ido")}>
                    <a onMouseEnter={cursorHover} onMouseLeave={resetCursor} href="#ido"><div className="line"></div>I do</a>
                </li>
                <li className={"link" + ((state.section === "work")? " active" :"")} onClick={() => changeSection("work")}>
                    <a onMouseEnter={cursorHover} onMouseLeave={resetCursor} href="#work"><div className="line"></div>Work</a>
                </li>
                <li className={"link" + ((state.section === "who")? " active" :"")} onClick={() => changeSection("who")}>
                    <a onMouseEnter={cursorHover} onMouseLeave={resetCursor} href="#who"><div className="line"></div>Who</a>
                </li>
                <li className={"contact link" + ((state.section === "contact")? " active" :"")} onClick={() => changeSection("contact")}>
